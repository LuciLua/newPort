        ...
        <li>
          <ul className="list-none xl:gap-10 gap-3 flex items-center w-fit h-full font-[600]">
            ...
            <div className="xl:hidden flex">
              <button className={`relative bg-[var(--text-h1)] text-[var(--bg-default)] text-[14px] p-[10px] font-[600] rounded-[3px] text-nowrap`} onClick={() => setOpenMenu(!openMenu)}>
                <BiMenu />
              </button>
              {openMenu &&
                <div className="absolute top-[55px] right-[55px] bg-[var(--bg-default)]">
                  ...
                  <li className="w-full text-gray-700 block px-4 py-2 text-sm hover:bg-gray-50">{translations.menu.projects}</li>
                  <li className="w-full text-gray-700 block px-4 py-2 text-sm hover:bg-gray-50">{translations.menu.about}</li>
                  <li className="w-full"><button className="text-gray-700 block  text-sm hover:bg-gray-50 w-full px-4 py-2" onClick={() => { toggleTheme() }}>Trocar tema</button></li>
                </div>
              }
            </div>
